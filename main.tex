...
\CTEXsetup[number={实验\chinese{section}}]{section} 
...
\input{sec/1-exp1.tex}

\input{sec/2-exp2.tex}

\input{sec/3-exp3.tex}

\input{sec/4-exp4.tex}

\input{sec/5-exp5.tex}

\input{sec/6-exp6.tex}
